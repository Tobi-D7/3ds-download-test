...
namespace d7gfx {
    Sprite::Sprite() :
            ...
            m_blendStrength(0.f),
            m_spriteSheetPath(""),
            m_tintColor(d7gfx::Color(255, 255, 255, 255)) {
                updateTint();
    ...
    void Sprite::setTint(d7gfx::Color t_color) {
        m_tintColor = t_color;
        updateTint();
    }

    d7gfx::Color Sprite::getTint() {
        return m_tintColor;
    }
    ...
    void Sprite::setTexture(d7gfx::Texture& t_texture) {
    ...
    void Sprite::draw(d7gfx::RenderContext t_context) {
    ...
    void Sprite::updateTint() {
        C2D_Tint tint = {
            d7gfx::Color(m_tintColor.getRed(), m_tintColor.getGreen(), m_tintColor.getBlue(), m_opacity).getRgba8(),
            m_blendStrength
        };
