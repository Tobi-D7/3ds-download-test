...
namespace d7gfx {
     ...
     */
    class Mesh: public d7gfx::Drawable {
    public:
        /**
        ...
        public:
             ...
             */
            Polygon(d7gfx::Mesh::Polygon::Vertex t_vertex0, d7gfx::Mesh::Polygon::Vertex t_vertex1, d7gfx::Mesh::Polygon::Vertex t_vertex2);
             ...
             * @param t_vertex2 The third vertex
             */
            void setVertices(d7gfx::Mesh::Polygon::Vertex t_vertex0, d7gfx::Mesh::Polygon::Vertex t_vertex1, d7gfx::Mesh::Polygon::Vertex t_vertex2);
             ...
             */
            d7gfx::Mesh::Polygon::Vertex getVertex(int t_id);

        private:
            /* data */
            d7gfx::Mesh::Polygon::Vertex m_vertices[3];
        };
         ...
         */
        void addPolygon(d7gfx::Mesh::Polygon t_polygon);
         ...
         */
        void setMaterial(d7gfx::Material& t_material);

        /**
         * @brief Returns the material of the mesh
         * @return The material
         */
        d7gfx::Material& getMaterial();
