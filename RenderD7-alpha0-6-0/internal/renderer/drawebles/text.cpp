...
namespace d7gfx {
    Text::Text(const std::string& t_text, d7gfx::Color t_color) :
        m_posX(0),
        m_posY(0),
        m_scaleX(1.f),
        m_scaleY(1.f),
    ...
    void Text::setPosition(d7gfx::Vector2f t_vector) {
        m_posX = t_vector.u;
        m_posY = t_vector.v;
    }
    ...
    BoundingBox Text::getBoundingBox() {
        ...
        return d7gfx::BoundingBox(m_posX, m_posY, static_cast<int>(width), static_cast<int>(height));
    }

    void Text::setColor(d7gfx::Color t_color) {
        m_color = t_color;
    }

    d7gfx::Color Text::getColor() {
        return m_color;
    }
