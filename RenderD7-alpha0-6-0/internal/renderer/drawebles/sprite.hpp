...
namespace d7gfx {
    ...
    public:
         ...
         */
        void setPosition(d7gfx::Vector2f t_vector);
         ...
         */
        void setTint(d7gfx::Color t_color);
         ...
         * @param t_texture The d7gfx::Texture to use
         */
        void setTexture(d7gfx::Texture& t_texture);
